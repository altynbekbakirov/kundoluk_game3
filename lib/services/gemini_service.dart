  ...
  Future<Question> generateQuestion(int level, String language) async {
    try {
      ...
      final fallbackQuestionsRu = [
        ...
        Question(
          question: 'Какое озеро является самым большим в Кыргызстане?',
          options: ['Сон-Куль', 'Иссык-Куль', 'Сары-Челек', 'Чатыр-Куль'],
          correctAnswer: 'Иссык-Куль',
        ),
        Question(
        ...
        Question(
          question: 'В каком году Кыргызстан получил независимость?',
          options: ['1990', '1991', '1992', '1993'],
          correctAnswer: '1991',
        ),
        Question(
          question: 'Кто написал эпос "Манас"?',
          options: ['Чингиз Айтматов', 'Токтогул Сатылганов', 'Народное творчество', 'Алыкул Осмонов'],
          correctAnswer: 'Народное творчество',
        ),
      ];

      final fallbackQuestionsKy = [
        Question(
        ...
        Question(
          question: 'Кыргызстандагы эң чоң көл кайсы?',
          options: ['Соң-Көл', 'Ысык-Көл', 'Сары-Челек', 'Чатыр-Көл'],
          correctAnswer: 'Ысык-Көл',
        ),
        Question(
          question: 'Кыргызстандын валютасы кандай?',
          options: ['Теңге', 'Сом', 'Рубль', 'Доллар'],
          correctAnswer: 'Сом',
        ),
        Question(
          question: 'Кыргызстан эгемендүүлүктү кайсы жылы алган?',
          options: ['1990', '1991', '1992', '1993'],
          correctAnswer: '1991',
        ),
        Question(
          question: '"Манас" эпосун ким жазган?',
          options: ['Чыңгыз Айтматов', 'Токтогул Сатылганов', 'Элдик чыгарма', 'Алыкул Осмонов'],
          correctAnswer: 'Элдик чыгарма',
        ),
      ];

      final questions = language == 'ru' ? fallbackQuestionsRu : fallbackQuestionsKy;
